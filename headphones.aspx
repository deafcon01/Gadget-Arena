<%@ Page Language="C#" AutoEventWireup="true" CodeFile="headphones.aspx.cs" Inherits="headphones" %>
...
<body>
    ...
    <div>
        ...
        <asp:Label ID="Label1" runat="server" CssClass="style1" Text="Headphone"></asp:Label>
        <br />
        <br />
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
            ...
            GridLines="Horizontal" CssClass="style2" Height="427px" Width="630px">
