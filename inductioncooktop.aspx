<%@ Page Language="C#" AutoEventWireup="true" CodeFile="inductioncooktop.aspx.cs" Inherits="inductioncooktop" %>
...
<body>
    ...
    <div>
        ...
        <asp:Label ID="Label1" runat="server" CssClass="style1" 
            Text="Induction Cooktop "></asp:Label>
        <br />
        <br />
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
            ...
            GridLines="Horizontal" CssClass="style2" Height="421px" Width="705px">
