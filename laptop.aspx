...
<body>
    ...
    <div>
        ...
        <asp:Label ID="Label1" runat="server" CssClass="style1" Text="Laptop"></asp:Label>
        <br />
        <br />
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
            ...
            GridLines="Horizontal" CssClass="style2" Height="436px" Width="787px">
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
            ...
            DeleteCommand="DELETE FROM [Product] WHERE [pid] = @original_pid AND [category] = @original_category AND [brand_name] = @original_brand_name AND [prod_name] = @original_prod_name AND [price] = @original_price AND [size] = @original_size AND [weight] = @original_weight AND [power_consmption] = @original_power_consmption AND [ram] = @original_ram AND [processing_speed] = @original_processing_speed AND [img_url] = @original_img_url" 
            InsertCommand="INSERT INTO [Product] ([category], [brand_name], [prod_name], [price], [size], [weight], [power_consmption], [ram], [processing_speed], [img_url]) VALUES (@category, @brand_name, @prod_name, @price, @size, @weight, @power_consmption, @ram, @processing_speed, @img_url)" 
            OldValuesParameterFormatString="original_{0}" 
            SelectCommand="SELECT [pid], [category], [brand_name], [prod_name], [price], [size], [weight], [power_consmption], [ram], [processing_speed], [img_url] FROM [Product] WHERE ([category] = @category)" 
            UpdateCommand="UPDATE [Product] SET [category] = @category, [brand_name] = @brand_name, [prod_name] = @prod_name, [price] = @price, [size] = @size, [weight] = @weight, [power_consmption] = @power_consmption, [ram] = @ram, [processing_speed] = @processing_speed, [img_url] = @img_url WHERE [pid] = @original_pid AND [category] = @original_category AND [brand_name] = @original_brand_name AND [prod_name] = @original_prod_name AND [price] = @original_price AND [size] = @original_size AND [weight] = @original_weight AND [power_consmption] = @original_power_consmption AND [ram] = @original_ram AND [processing_speed] = @original_processing_speed AND [img_url] = @original_img_url">
            <DeleteParameters>
