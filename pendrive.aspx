<%@ Page Language="C#" AutoEventWireup="true" CodeFile="pendrive.aspx.cs" Inherits="pendrive" %>
...
<body>
    ...
    <div>
        ...
        <asp:Label ID="Label1" runat="server" CssClass="style1" Text="Pen Drive"></asp:Label>
        <br />
        <br />
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
            ...
            GridLines="Horizontal" CssClass="style2" Height="429px" Width="677px">
