<%@ Page Language="C#" AutoEventWireup="true" CodeFile="refrigerator.aspx.cs" Inherits="refrigerator" %>
...
<body>
    ...
    <div>
        ...
        <asp:Label ID="Label1" runat="server" CssClass="style1" Text="Refrigerator"></asp:Label>
        <br />
        <br />
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
            ...
            CssClass="style2" GridLines="Horizontal" Height="417px" Width="687px">
